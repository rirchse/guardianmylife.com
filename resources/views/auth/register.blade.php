        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="lead_type">Choose a Service
                        <br><span class="label-detail">What is kind of business plan do you like? </span>
                    </label>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="first_name">First Name
                        <br><span class="label-detail">Type your first name following the Govt. NID Card </span></label>
                    <input type="text" class="form-control" id="first_name" name="first_name" required placeholder="Example: Mr. John">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    <label for="last_name">Last Name
                        <br><span class="label-detail">Type your first name following the Govt. NID Card</span>
                    </label>
                    <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Example: Little">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    <label for="mobile">Mobile Number
                        <br><span class="label-detail">We will send you verification and imortant information</span>
                    </label>
                    <input type="text" class="form-control" id="mobile" name="mobile" onkeyup="phoneFormat(this)" required  placeholder="(000) 000-0000">
                </div>
            </div>
            {{-- <div class="col-md-12">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="email">Email Address
                        <br><span class="label-detail">We will send you a verification code to this email.</span>
                    </label>
            ...
            {{-- <div class="col-md-12 LI">
                ...
                <div class="form-group">
                    <label for="date_of_birth">Date of Birth
                        <br><span class="label-detail">Provide your date of birth following the Gov. NID Card.</span>
                    </label>
            ...
            {{-- <div class="col-md-12">
                <div class="form-group">
                    <label for="street_address">Street Address
                        <br><span class="label-detail">Provide your permanent address</span>
                    </label>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="notes">Notes
                        <br><span class="label-detail">You can write something here to share with us your oppinion.</span>
                    </label>
