                      ...
                      <div class="elementor-element elementor-element-526c813d elementor-icon-list--layout-inline elementor-align-right elementor-mobile-align-center elementor-widget__width-initial elementor-tablet-align-center elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="526c813d" data-element_type="widget" data-widget_type="icon-list.default">
                        <div class="elementor-widget-container">
                          ...
                          <ul class="elementor-icon-list-items elementor-inline-items">
                            ...
                            <li class="elementor-icon-list-item elementor-inline-item">
                              <a href="www.linkedin.com/in/mesidorguardianmylife" target="_blank">
                                <span class="elementor-icon-list-icon">
                      ...
                      <div class="elementor-element elementor-element-365d532 elementor-align-right elementor-widget__width-initial elementor-mobile-align-justify elementor-widget-mobile__width-inherit elementor-hidden-mobile elementor-tablet-align-right excludedarkmode blackborderedhoverbuttons  elementor-widget elementor-widget-button" data-id="365d532" data-element_type="widget" data-widget_type="button.default">
                        <div class="elementor-widget-container">
                          <div class="elementor-button-wrapper">
                            <a class="elementor-button elementor-button-link elementor-size-md" href="{{route('home.client.apply')}}" style="background:#fff">
                ...
                <div class="elementor-widget-container">
                  <ul class="elementor-icon-list-items elementor-inline-items">
                    <li class="elementor-icon-list-item elementor-inline-item">
                      ...
                      <span class="elementor-icon-list-text">{{date('Y')}}</span>
                    </li>
                    <li class="elementor-icon-list-item elementor-inline-item">
