    ...
    <div class="card-body">
      ...
      <table class="table">
        {{-- <tr>
          <th>Call Time:</th>
          <td colspan="2">
            <button id="timerButton1" class="timerButton btn btn-primary">Start Timer</button>
          </td>
        </tr> --}}
        <tr>
          <th>Lead Type</th>
        ...
        <tr>
          <td colspan="2">
            <div style="max-width: 400px" class="hide" id="call_end">
              {{-- <button class="btn btn-warning" style="width:48%;display:inline-block" onclick="callHang(this)"><i class="fa fa-phone"></i> Hang On</button> --}}
