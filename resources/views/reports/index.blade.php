...
@section('content')
@if(Auth::user()->role == 1)
<a href="{{route('admin.reports')}}" class="btn btn-danger my-3 d-print-none">Admin Report</a>
@endif
...
<div class="row">
  <div class="col-md-12">
    <div class="card card-body d-print-none">
        ...
        <form class="fo/rm for/m-inline"  method="get" action="{{route('reports.dailysumhours')}}">
          @csrf
        <div class="row">  
            <div class="col">
                ...
                <label>User </label>
                  <select name="user_id" required id="" class="form-control">
                    ...
                    @endphp
                      ...
                      <option value="{{ $user->id }}" {{ ($userId && $user->id == $userId) ? 'selected' : '' }}>
                        {{ $user->name }}
                    </option>
  ...
  <div class="col-md-12">
    ...
    <div class="d-print-block d-none" style="position: relative;">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="stati bg-concrete left" style="border: 1px solid gray;">
                    ...
                    <div>
                        <b>{{$source->dformat($from)}} - {{$source->dformat($to)}}</b>
                        <span>Period</span>
                    </div>
                </div>
            </div>
            ...
            <div style="padding-top: 15px;font-size: 14px;">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control col-md-6 reportfield" value="{{ "$".number_format($balance, 2) }}">
                    </div>
                </div>
            </div>
            ...
            <div style="padding-top: 15px;font-size: 14px;">
                <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" class="form-control col-md-6 reportfield" value="{{isset($leads)?$leads:''}}">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control col-md-6 reportfield" value="${{isset($cost_per_lead) ? number_format($cost_per_lead, 2) : ''}}">
                    </div>
                </div>
            </div>
            ...
            <div style="padding-top: 15px;font-size: 14px;">
                <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" class="form-control reportfield col-md-6" value="{{isset($calls)?$calls:''}}">
                    </div>
                    
                   <div class="form-group col-md-6">
                      <label for="inputEmail4"  class="col-md-6" style="float:left;">Total Call Hours</label>
                      <input type="email" class="form-control reportfield col-md-6" value="{{isset($totalcallingHours)? $totalcallingHours : ''}}">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputPassword4"  class="col-md-6" style="float:left;">Average Call Hours</label>
                      <input type="text" class="form-control reportfield col-md-6" value="{{isset($average_call_time)?$average_call_time:''}}">
                    </div>
                    
                    <div class="form-group col-md-6">
                      <label for="inputPassword4"  class="col-md-6" style="float:left;">Total Working Hours</label>
                      <input type="text" class="form-control reportfield col-md-6" value="{{isset($totalWorkingHours)?$totalWorkingHours:''}}">
                    </div>
                </div>
            </div>
            ...
            <div style="padding-top: 15px;font-size: 14px;">
                <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" class="form-control reportfield col-md-6" value="{{isset($yes)?$yes:''}}">
                    </div>
                    
                    <div class="form-group col-md-6">
                      <label for="inputPassword4"  class="col-md-6" style="float:left;">Contacts (No)</label>
                      <input type="text" class="form-control reportfield col-md-6" value="{{isset($no)?$no:''}}">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control reportfield col-md-6" value="{{isset($wrong)?$wrong:''}}">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputEmail4"  class="col-md-6" style="float:left;">Contacts (Not Interested)</label>
                      <input type="email" class="form-control col-md-6 reportfield" value="{{isset($interested)?$interested:''}}">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control col-md-6 reportfield" value="{{isset($remainders)?$remainders:''}}">
                    </div>
                    
                   <div class="form-group col-md-6">
                      <label for="inputEmail4"  class="col-md-6" style="float:left;">Contacts (Disconnect)</label>
                      <input type="email" class="form-control col-md-6 reportfield" value="{{isset($disconnect)?$disconnect:''}}">
                    </div>
                </div>
            </div>
            ...
            <div style="padding-top: 15px;font-size: 14px;">
                <div class="form-row">
                   <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control col-md-6 reportfield" value="{{isset($appointment_sat)?$appointment_sat:''}}">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputPassword4" class="col-md-6" style="float:left;">Appointments Set</label>
                      <input type="text" class="form-control col-md-6 reportfield" value="{{isset($appoinements)?$appoinements:''}}">
                    </div>                    
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="email" class="form-control col-md-6 reportfield" value="{{isset($appointment_sat_ratio)? $appointment_sat_ratio : ''}}%">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputEmail4" class="col-md-6" style="float:left;">Appointments Sold</label>
                      <input type="email" class="form-control col-md-6 reportfield" value="{{isset($sold)?$sold:''}}">
                    </div>
                 ...
                 <div class="form-row">
                    <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control col-md-6 reportfield" value="{{isset($appointment_ratio)? $appointment_ratio : ''}}%">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputPassword4" class="col-md-6" style="float:left;">Sales Ratio</label>
                      <input type="text" class="form-control col-md-6 reportfield" value="{{isset($sales_ratio)?$sales_ratio:''}}%">
                    </div>
                </div>        
            </div>
      ...
      <!--<table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          <th>Total Calls</th>
         <td>{{isset($calls)?$calls:''}}</td>
         <th>Appointments Set</th>  
         <td>{{isset($appointment_sat)?$appointment_sat:''}}</td>                
        </tr>
        <tr>
          <th>Contact (Yes)</th>
         <td>{{isset($yes)?$yes:''}}</td>
         <th>Appointment (Sold)</th>  
         <td>{{isset($sold)?$sold:''}}</td>            
        </tr>
        <tr>
          <th>Contacts (Wrong)</th>
         <td>{{isset($wrong)?$wrong:''}}</td>
         <th>Contacts (Disconnect)</th>  
         <td>{{isset($disconnect)?$disconnect:''}}</td>                
        </tr>
        
        <tr>
          <th>Contact(Remainder)</th>
          <td>{{isset($remainders)?$remainders:''}}</td>                                       
         <th>Contacts (Not Interested)</th>
         <td>{{isset($interested)?$interested:''}}</td>                              
        </tr>
        ...
        <tr>
         ...
         <td>{{isset($appoinements)?$appoinements:''}}</td>
         <th>Commission</th>  
         <td>${{isset($totalCommissionPayment)?$totalCommissionPayment:''}}</td> 
        </tr>
        
        <tr>
          <th>Sales Ratio</th>
          <td>{{isset($ratio)?$ratio:''}}%</td>
          <th>Balance Due</th>
          <td>${{isset($totalBalanceDueLater)?$totalBalanceDueLater:''}}</td> 
        </tr>
        <tr>
          <th>Leads Purchased</th>
          <td>{{isset($leads)?$leads:''}}</td>  
          <th>Budget</th>
          <td>${{isset($budget)?$budget:''}}</td>      
        </tr>

        <tr>
          <th>Leads Cost</th>
          <td>${{isset($cost)?$cost:''}}</td> 
          <th>Budget Used</th>   
          <td>${{isset($cost)?$cost:''}}</td>   
        </tr>
        ...
        <tr>
          <th>Cost Per Lead</th>
          <td>${{isset($cost_per_lead) ? number_format($cost_per_lead, 2) : ''}}</td>
          <th>Balance</th>
          <td>${{isset($balance)?$balance:''}} </td>    
        </tr> 
        <tr>
          <th>Total Call Hours</th>
          <td>{{isset($totalcallingHours)? $totalcallingHours : ''}}</td>
          <th>Avernage Call Hours</th>
          <td>{{isset($average_call_time)?$average_call_time:''}} </td>    
        </tr> 
        
        <tr>
          <th>Appointment Ratio</th>
          <td>{{isset($appointment_ratio)? $appointment_ratio : ''}}%</td>
          <th>Appointment Sat Ratio</th>
          <td>{{isset($appointment_sat_ratio)? $appointment_sat_ratio : ''}}%</td>
        </tr> 
        
        <tr>
          <th>Total Monthly Sales</th>
          <td>{{isset($customerMonthlyPremium)? $customerMonthlyPremium : ''}}</td>
          <th>Total Annual Sales</th>
          <td>{{isset($annualCustomerPayment)? $annualCustomerPayment : ''}}</td>
        </tr> 
