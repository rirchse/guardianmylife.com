...
<head>
  ...
  <title><?php echo e(config('app.name')); ?> | Home Page</title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/ckeditor/bootstrap3-wysihtml5.min.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('/ckeditor/glyphicons.css')); ?>">
  <!-- DataTables -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="position: fixed;">
    ...
    <div class="sidebar" style="height:85vh;overflow:auto">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo e(asset('admin/logo.png')); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar nav-child-indent flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li>
                <a href="<?php echo e(route('lead.upload')); ?>" class="nav-link"><i class="fas fa-upload"></i> File Upload</a>
              </li>
              <li>
                <a href="<?php echo e(route('lead.create')); ?>" class="nav-link"><i class="fas fa-plus"></i> Add Lead</a>
              </li>
              <?php endif; ?>
              <li>
                <a href="<?php echo e(route('lead.index')); ?>" class="nav-link"><i class="fas fa-list"></i> View Leads</a>
              </li>
              <?php if(Auth::user()->role == 2 || Auth::user()->role == 1): ?>
              <li>
                <a href="<?php echo e(route('employeeleads.assign.index')); ?>" class="nav-link">
          ...
          <?php if(Auth::user()->role == 2 || Auth::user()->role == 1): ?>
          <li class="nav-item">
            <a href="<?php echo e(route('remainder.index')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('call.index')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('logs.index')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('reports.dailysumhours')); ?>" class="nav-link">View Reports</a>
              </li>
            </ul>
          </li>         
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('user.forgetpassword')); ?>" class="nav-link">
              <i class="fa fa-users" aria-hidden="true"></i>
              <p>Forgot Password</p>
            </a>
          </li>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('schedule.create')); ?>">Add Schedule</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('schedule.index')); ?>">View Schedule</a>
              </li>
            </ul>
          </li>
...
<script src="<?php echo e(asset('/ckeditor/bootstrap3-wysihtml5.all.min.js')); ?>"></script>
...
<script>
  ...
  function storeTimeInDatabase(time)
  {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('workingHours')); ?>",
      data: {
        hours: hours,
        minutes: minutes,
        seconds: seconds
...
</html><?php /**PATH /srv/www/fflfalcon/resources/views/layouts/main.blade.php ENDPATH**/ ?>