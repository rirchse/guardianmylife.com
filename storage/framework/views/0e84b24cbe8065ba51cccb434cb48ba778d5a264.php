	...
	<div class="wrapper" style="max-width:700px; margin:15px auto; font-family: sans-serif;">
		...
		<div section="body" style="background:#fff; margin-bottom:5px">
			<div style="overflow: hidden;">
				<img src="<?php echo e($message->embed($banner)); ?>" alt="" style="width:100%">
				<div style="padding:25px; text-align:left; font-family:sans-serif;color: #525252;">
					<p style="font-weight:bold"><?php echo $email_title; ?></p>
					<p style="text-align: center;font-size:18px"><?php echo $email_body; ?></p>
        </div>
			</div>
		</div>
		<!-- email footer -->
		...
		<div style="padding-bottom: 30px; background: #fff; padding: 25px; display: block;">
			<img src="<?php echo e($message->embed($logo)); ?>" alt="logo" style="float: left; display: flex; width: 180px; padding: 20px;">
			<p style="font-size: 21px; width:100%">
			Mesidor Azor<br>
			Founder & CEO<br>
			<a href="http://guardianmylife.com" target="_blank"><?php echo e(config('app.name')); ?></a><br>
			Address:<br>
...
</html><?php /**PATH /srv/www/fflfalcon/resources/views/mail/default.blade.php ENDPATH**/ ?>