                        ...
                        <div class="elementor-widget-container">
                          ...
                          <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container" aria-hidden="true">
                            <ul id="menu-2-2e3d4fd" class="elementor-nav-menu">
                              ...
                              <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1049"><a href="<?php echo e(route('login')); ?>" class="elementor-item" tabindex="-1"><img src="/home/images/user-profile-filled-svgrepo-com.svg" class="_mi _before _svg" aria-hidden="true" alt="" width="25" height="25"/><span>Agent Login</span></a></li>
                              <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1062"><a href="<?php echo e(route('home.client.apply')); ?>" class="elementor-item" tabindex="-1"><img loading="lazy" src="/home/images/icon-arrow-right-apply-to-work-with-ffl.svg" class="_mi _before _svg" aria-hidden="true" alt="" width="25" height="25"/><span>Apply to Work with GML</span></a></li>
